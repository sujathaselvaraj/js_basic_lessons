const toppings = ['Mushrooms ', 'Tomatoes', 'Eggs', 'Chili', 'Lettuce', 'Avocado', 'Chiles', 'Bacon', 'Pickles', 'Onions', 'Cheese'];
    ...
    function logItemsInArray(items, index, originalArray) {
        ...
        previtem ? console.log('previousItem : ' + previtem) : null;
    ...
    function increament(items) {
        console.log( items * 1.25);
    }
    console.log(orderTotals);
    orderTotals.forEach(increament);
